"""Module defining custom local jinja filters and extensions for cookiecutter."""
...
def as_datetime(value: int) -> datetime:
    """Given an epoch integer value, return a datetime in UTC"""
...
FILTERS: Mapping[str, Callable] = {
    ...
    "sql_not_in": not_in_,
    "random_n": random_n,
    "snake_case": as_snake_case,
}


class BpsExampleExtension(Extension):
    def __init__(self, environment):
        super(BpsExampleExtension, self).__init__(environment)
